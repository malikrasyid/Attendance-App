namespace Attendance_App
{
    partial class HomeAdministrator
    {
        ...
        private void InitializeComponent()
        {
            ...
            // userButton
            // 
            userButton.BackColor = Color.FromArgb(126, 172, 120);
            userButton.FlatStyle = FlatStyle.Flat;
            userButton.ForeColor = Color.FromArgb(246, 246, 246);
            userButton.Location = new Point(97, 60);
            userButton.Name = "userButton";
            userButton.Size = new Size(125, 57);
            ...
            EventButton.Location = new Point(97, 214);
            EventButton.Name = "EventButton";
            EventButton.Size = new Size(125, 57);
            EventButton.TabIndex = 2;
            EventButton.Text = "Event";
            EventButton.UseVisualStyleBackColor = false;
            // 
            // subjectButton
            // 
            subjectButton.BackColor = Color.FromArgb(126, 172, 120);
            subjectButton.FlatStyle = FlatStyle.Flat;
            subjectButton.ForeColor = Color.FromArgb(246, 246, 246);
            subjectButton.Location = new Point(405, 214);
            subjectButton.Name = "subjectButton";
            subjectButton.Size = new Size(125, 57);
            subjectButton.TabIndex = 3;
